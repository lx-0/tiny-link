      ...
      <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-4 grid grid-cols-1 gap-5 sm:grid-cols-3">
          ...
          <StatCard
            ...
            bg="bg-green-100"
            change={stats.totalClicks > 0 ? { value: '12%', positive: true } : undefined}
          />
          <StatCard
          ...
          <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
            ...
            <Select value={sortOption} onValueChange={setSortOption}>
              ...
              <SelectContent>
                ...
                <SelectItem value="most-clicked">Sort by: Most Clicked</SelectItem>
                <SelectItem value="least-clicked">Sort by: Least Clicked</SelectItem>
              </SelectContent>
            </Select>
          </div>
        </div>
            ...
            {urlsError && filteredAndSortedUrls.length === 0 && (
              <div className="mt-6 bg-red-50 border border-red-200 rounded-md p-4">
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <h3 className="text-sm font-medium text-red-800">Failed to load URLs</h3>
